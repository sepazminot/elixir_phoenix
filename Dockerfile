...
#   - Ex: docker.io/hexpm/elixir:1.19.5-erlang-28.4.1-debian-trixie-20260505-slim
#
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/elixir_phoenix ./
...
CMD ["/app/bin/elixir_phoenix", "start"]
